            ...
            <Card className="relative">
              ...
              <CardContent>
                <div className="flex flex-col items-center py-2">
                  <div className="relative flex h-52 w-52 items-center justify-center rounded-full" style={{ background: `conic-gradient(#0b8f86 ${index * 10}%, #e5eeec 0)` }}><div className="flex h-40 w-40 flex-col items-center justify-center rounded-full bg-white shadow-[inset_0_0_25px_rgba(30,75,80,.08)]"><span className="text-6xl font-semibold tracking-[-0.07em] text-[#153d46]">{index}</span><span className="mt-1 text-[10px] font-bold uppercase tracking-[0.2em] text-[#25845e]">Excellent</span></div></div>
                  <div className="mt-7 grid w-full grid-cols-3 divide-x divide-[#e1eae8] rounded-xl border border-[#e1eae8] bg-[#f8fbfa] py-3 text-center"><div><p className="text-lg font-semibold text-[#153d46]">{total}</p><p className="text-[9px] uppercase tracking-wider text-[#70878b]">Species</p></div><div><p className="text-lg font-semibold text-[#153d46]">4</p><p className="text-[9px] uppercase tracking-wider text-[#70878b]">Guilds</p></div><div><p className="text-lg font-semibold text-[#25845e]">Stable</p><p className="text-[9px] uppercase tracking-wider text-[#70878b]">Trend</p></div></div>
                </div>
              </CardContent>
            </Card>
          </div>
